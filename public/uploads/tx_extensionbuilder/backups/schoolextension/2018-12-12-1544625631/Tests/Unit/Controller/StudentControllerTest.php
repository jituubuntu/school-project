...
{
    /**
     * @var \School\Schoolextension\Controller\StudentController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\School\Schoolextension\Controller\StudentController::class)
    ...
    public function listActionFetchesAllStudentsFromRepositoryAndAssignsThemToView()
    {
        ...
        $studentRepository = $this->getMockBuilder(\School\Schoolextension\Domain\Repository\StudentRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $student = new \School\Schoolextension\Domain\Model\Student();
