...
{
    /**
     * @var \School\Schoolextension\Controller\TeacherController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\School\Schoolextension\Controller\TeacherController::class)
    ...
    public function listActionFetchesAllTeachersFromRepositoryAndAssignsThemToView()
    {
        ...
        $teacherRepository = $this->getMockBuilder(\School\Schoolextension\Domain\Repository\TeacherRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $teacher = new \School\Schoolextension\Domain\Model\Teacher();
