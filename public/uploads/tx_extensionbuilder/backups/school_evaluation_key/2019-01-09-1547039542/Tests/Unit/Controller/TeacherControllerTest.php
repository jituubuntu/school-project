...
{
    /**
     * @var \SchoolEvaluation\SchoolEvaluationKey\Controller\TeacherController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\SchoolEvaluation\SchoolEvaluationKey\Controller\TeacherController::class)
    ...
    public function listActionFetchesAllTeachersFromRepositoryAndAssignsThemToView()
    {
        ...
        $teacherRepository = $this->getMockBuilder(\SchoolEvaluation\SchoolEvaluationKey\Domain\Repository\TeacherRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $teacher = new \SchoolEvaluation\SchoolEvaluationKey\Domain\Model\Teacher();
