...
return [
    'ctrl' => [
        ...
        'searchFields' => 'first_name,last_name,marks,attendance,dob,email',
        'iconfile' => 'EXT:school_evaluation_key/Resources/Public/Icons/tx_schoolevaluationkey_domain_model_student.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, first_name, last_name, marks, attendance, dob, email',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, first_name, last_name, marks, attendance, dob, email, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'marks' => [
            'exclude' => true,
            'label' => 'LLL:EXT:school_evaluation_key/Resources/Private/Language/locallang_db.xlf:tx_schoolevaluationkey_domain_model_student.marks',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim'
